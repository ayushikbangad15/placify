...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      route: "/resume-checker",  // <- Added route here
    },
    {
      icon: Bot,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              // Placify ChatBot card: link to /chatbot
              if (feature.title.trim().toLowerCase() === "placify chatbot") {
                return (
                  <Link to="/chatbot" key={index} style={{ textDecoration: "none" }}>
                    <Card>
                      <CardHeader>
