...
"Quantitative Aptitude": "https://www.youtube.com/playlist?list=PLpyc33gOcbVA4qXMoQ5vmhefTruk5t9lt",
  ...
  "Mini Projects (with Source Code)": "https://www.youtube.com/watch?v=fMzmPj8d4wI",
  "Responsive Design Tips": "https://www.youtube.com/watch?v=srvUrASNj0s",
  "Cybersecurity (for Cyber branch)": "https://www.youtube.com/watch?v=vpJWigE3yRc",
  "AIML": "https://www.youtube.com/watch?v=ukzFI9rgwfU",
  "Data science": "https://www.youtube.com/watch?v=vl0p4ahv8xE",
  "IoT": "https://www.youtube.com/watch?v=q_T3ndgy5iw",
  // Core
  ...
  // Soft Skills
  "Spoken English Practice": "https://www.youtube.com/watch?v=KdRrrTDv2Jc",
  "Email & Resume Writing": "https://www.youtube.com/watch?v=Vp7xv4YgSKc",
  "Presentation Skills": "https://www.youtube.com/watch?v=rUu5h2uRUwQ",
  "Confidence & Body Language Tips": "https://www.youtube.com/watch?v=gzbOIVNQF4U",
  "Public Speaking": "https://www.youtube.com/watch?v=H-An6xKzJgA",
  // Interview Preparation
  "HR Interview": "https://www.youtube.com/watch?v=ea1pF59V7qg",
  "Common Questions + Sample Answers": "https://www.youtube.com/watch?v=ea1pF59V7qg",
  "Tell Me About Yourself": "https://www.youtube.com/watch?v=ea1pF59V7qg",
  "Strengths & Weaknesses Examples": "https://www.youtube.com/watch?v=ea1pF59V7qg",
  "Technical Interview": "https://www.youtube.com/watch?v=t8pPdKYpowI",
  "Subject-wise Q&A": "https://www.youtube.com/results?search_query=subject+wise+interview+questions",
  "Coding Questions": "https://www.youtube.com/watch?v=t8pPdKYpowI",
  "Project-based Questions": "https://www.youtube.com/watch?v=ea1pF59V7qg",
  "Mock Interview Practice": "https://www.youtube.com/results?search_query=mock+interview+practice",
  "Self-recording Tips": "https://www.youtube.com/results?search_query=self+recording+interview+tips",
  "Mock Interview Platforms": "https://www.youtube.com/results?search_query=mock+interview+platforms",
  // Group Discussion & Extempore
  "GD Rules & Etiquette": "https://www.youtube.com/watch?v=F4afAhEv8Ls",
  "Latest GD Topics (Tech + Social)": "https://www.youtube.com/watch?v=F4afAhEv8Ls",
  "How to Start / Conclude GD": "https://www.youtube.com/watch?v=F4afAhEv8Ls",
  "Extempore Speaking Tips": "https://www.youtube.com/watch?v=F4afAhEv8Ls",
  "Sample GD Videos": "https://www.youtube.com/watch?v=F4afAhEv8Ls",
  "Do’s & Don’ts Guides": "https://www.youtube.com/watch?v=F4afAhEv8Ls",
  // LinkedIn & Branding
        ...
        <section key={section.id} className="max-w-5xl mx-auto mb-12 bg-white rounded-2xl shadow-lg py-8 px-5 md:px-10 transition hover:shadow-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {section.subtopics.map((topic, idx) => {
              ...
              const assessmentLink = `/assessment/${topic.name.toLowerCase().replace(/\s+/g, "-")}`;
              return (
                <div key={idx} className="bg-gradient-to-tr from-blue-20 to-cyan-100 rounded-xl shadow-md p-4 border border-blue-100 hover:border-blue-400 transition flex flex-col items-start">
                  ...
                  <div className="flex gap-2 mb-2">
                    ...
                    <Link to={assessmentLink} className="px-3 py-1 text-sm rounded bg-indigo-600 text-white font-medium hover:bg-indigo-500 transition">Assessment</Link>
                  </div>
                  {topic.resource && (
