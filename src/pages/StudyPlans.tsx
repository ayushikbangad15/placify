...
import { mockStudyPlans } from '@/lib/mockData';
...
const StudyPlans = () => {
  ...
  // Recommended Sources Data with URLs
  ...
  // Browsing Materials Data with URLs
  ...
  const currentPlan = mockStudyPlans[selectedYear as unknown as keyof typeof mockStudyPlans];
  const completedMilestones = currentPlan.milestones.filter(m => m.completed).length;
  const progressPercentage = Math.round((completedMilestones / currentPlan.milestones.length) * 100);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pt-8 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          {Object.entries(mockStudyPlans).map(([year, plan]) => {
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex justify-between text-sm text-gray-600 mt-2">
                <span>{completedMilestones} of {currentPlan.milestones.length} milestones completed</span>
                <span>{currentPlan.milestones.length - completedMilestones} remaining</span>
              </div>
            </CardContent>
          </Card>
